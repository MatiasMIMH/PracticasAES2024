...
<body>
    ...
    <div class="fondo" style="background-image: url('../imagenes/fondo_index.jpg');">
    <?php include("header.php")?>
        <div class="cabecera">
            <table>
                ...
                <tr>
                    ...
                    <td class="td_drch" rowspan ="2";>
                        <p style="color: gray;">Demoliciones y Gestión de Amianto, s.l.</p>
                        <p>N.I.F.: B27861699</p>
                        <p style="color: gray;">Oficina Central:</p>
                        <p>Mª Berdiales, 41 - 1º, 36203 Vigo</p>
            ...
            <div class="titulo_index">
                <h1>Especialistas en Demoliciones, Descontaminación y Gestión de Residuos</h1>
            </div>
    </div>
</body>
</html>