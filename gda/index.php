<?php
    include("secciones/conexion.php");
    $conexion= conexion();
...
<body>
    ...
    <div class="contenedor" style = "overflow-y: hidden;">
        <div class="fondo_index" style="background-image: url('imagenes/<?php echo $row["fondo"]?>');">
            <div class="cabecera">
                <table>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="td_drch" rowspan ="2";>
                            ...
                            <p><?php 
                                    echo $rowDireccionEmpresaPrincipal["calle"].", ";
