...
<div class="fibrocemento">
    ...
    <div class="textosFibrocemento">
        <div class="textoFibrocemento1">
            <p>El principal riesgo de contaminación con el amianto se produce durante el proceso de retirada de  los materiales que lo contienen.</p> 
            <p>Un desamiantado mal realizado, produce una contaminación ambiental por emisión de fibras de amianto muy  superior que la generada por la simple
                presencia del material sin descontaminar.</p>
            <p>Por ello, los trabajos se deben desarrollar adoptando una serie de medidas preventivas que garanticen la seguridad personal de los trabajadores 
        ...
        <div class="textoFibrocemento3">
                ...
                <img  class="imagen3Fibrocemento" src="imagenes/retiradaFibrocemento/imgRetirada.jpg"> <!--Aqui la img de la izq-->
            <div class="txtFibrocemento3">
        ...
        <div class="cuadroFinal">
            ...
            <hr></hr>
            <div class="iconos">
                <img class="iconoUser" src="../imagenes/iconos/usuario.png">
                <img class="iconoPortap" src="../imagenes/iconos/portapapeles.png">
                <img class="iconoCasa" src="../imagenes/iconos/segurohogar.png">
                <img class="iconoCamion" src="../imagenes/iconos/camion.png">
                <img class="iconoLista" src="../imagenes/iconos/listacontactos.png">
            </div>
            <div class="textosCuadroFinal">
                <p class="textoUser">Les asesoramos <br>y facilitamos un <br>presupuesto</p>
                <p class="textoPortapapeles">Realizamos  las <br>tramitaciones con las <br>autoridades laborales <br>y ambientales</p>
                <p class="textoCasa">Preparamos todas <br>lasmedidas de seguridad <br>y ejecutamos el <br>desamiantado</p>
                <p class="textoCamion">Transportamos <br>y gestionamos el fibrocemento <br>en planta autorizada por <br>medioambiente</p>
        ...
        <div class="cuadroFinal">
            <table>
                <tr>
                    <td><img class="iconoUser" src="imagenes/iconos/usuario.png"></td>
                    <td><img class="iconoPortap" src="imagenes/iconos/portapapeles.png"></td>
                    <td><img class="iconoCasa" src="imagenes/iconos/segurohogar.png"></td>
                    <td><img class="iconoCamion" src="imagenes/iconos/camion.png"></td>
                    <td><img class="iconoLista" src="imagenes/iconos/listacontactos.png"></td>
                </tr>
                <tr>
                        <td><p class="textoUser">Les asesoramos <br>y facilitamos un <br>presupuesto</p></td>
                        <td><p class="textoPortapapeles">Realizamos  las <br>tramitaciones con las <br>autoridades laborales <br>y ambientales</p></td>
                        <td><p class="textoCasa">Preparamos todas <br>lasmedidas de seguridad <br>y ejecutamos el <br>desamiantado</p></td>
                        <td><p class="textoCamion">Transportamos <br>y gestionamos el fibrocemento <br>en planta autorizada por <br>medioambiente</p></td>
                        <td><p class="textoLista">Les entregamos <br>documento de identificación <br>del porte y certificado del <br>gestor final</p></td>
                </tr>
            </table>
        </div>
